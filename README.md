...
Django, PostgreSQL, Docker, RabbitMQ, Celery, Stripe(платежная система), Redis
...
### Расширение функций магазина (v.2)
* Создание системы купонов для применения скидок
* Применение купонов в корзине и к заказам
* Создание купонов для Stripe Checkout
* Создание системы рекомендаций по продуктам с помощью Redis
